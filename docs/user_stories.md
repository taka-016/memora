...
- [9. ユーザーとして、旅行のタスクを管理したい。旅行計画とタスクを一元管理したいから](#9-ユーザーとして旅行のタスクを管理したい旅行計画とタスクを一元管理したいから)
- [10. ユーザーとして、同じ場所の過去の記録を見たい。お気に入りの場所は何度も訪れることがあるから](#10-ユーザーとして同じ場所の過去の記録を見たいお気に入りの場所は何度も訪れることがあるから)
- [11. ユーザーとして、地図表示から訪問場所を確認したい。訪れたことのある場所を俯瞰したいから](#11-ユーザーとして地図表示から訪問場所を確認したい訪れたことのある場所を俯瞰したいから)
- [12. ユーザーとして、過去の旅行を検索したい。年表から探し出すのは大変だから](#12-ユーザーとして過去の旅行を検索したい年表から探し出すのは大変だから)
- [13. ユーザーとして、グループイベントを管理したい。年表セルのメモとして過去の出来事や未来の予定を残したいから](#13-ユーザーとしてグループイベントを管理したい年表セルのメモとして過去の出来事や未来の予定を残したいから)
- [14. ユーザーとして、グループのメンバー別イベントを管理したい。特定のメンバーに関連する出来事を記録したいから](#14-ユーザーとしてグループのメンバー別イベントを管理したい特定のメンバーに関連する出来事を記録したいから)
- [15. ユーザーとして、DVCポイント契約とユースイヤーをグループ単位で管理したい。契約条件を正しく反映してポイントを運用したいから](#15-ユーザーとしてdvcポイント契約とユースイヤーをグループ単位で管理したい契約条件を正しく反映してポイントを運用したいから)
- [16. ユーザーとして、DVCポイントの利用可能数を月ごとに把握し、利用登録したい。失効を避けつつ最適にポイントを使いたいから](#16-ユーザーとしてdvcポイントの利用可能数を月ごとに把握し利用登録したい失効を避けつつ最適にポイントを使いたいから)
- [17. ユーザーとして、期間限定で付与されるDVCポイントを管理したい。ワンタイムユース等で付与されたポイントを正しく反映したいから](#17-ユーザーとして期間限定で付与されるdvcポイントを管理したいワンタイムユース等で付与されたポイントを正しく反映したいから)
- [18. ユーザーとして、年表画面でDVCポイント利用履歴を確認し、そのまま編集したい。年表とポイント管理を往復しやすくしたいから](#18-ユーザーとして年表画面でdvcポイント利用履歴を確認しそのまま編集したい年表とポイント管理を往復しやすくしたいから)
...
## 9. ユーザーとして、旅行のタスクを管理したい。旅行計画とタスクを一元管理したいから
...
## 10. ユーザーとして、同じ場所の過去の記録を見たい。お気に入りの場所は何度も訪れることがあるから
...
## 11. ユーザーとして、地図表示から訪問場所を確認したい。訪れたことのある場所を俯瞰したいから
...
## 12. ユーザーとして、過去の旅行を検索したい。年表から探し出すのは大変だから
...
## 13. ユーザーとして、グループイベントを管理したい。年表セルのメモとして過去の出来事や未来の予定を残したいから
...
## 14. ユーザーとして、グループのメンバー別イベントを管理したい。特定のメンバーに関連する出来事を記録したいから
...
## 15. ユーザーとして、DVCポイント契約とユースイヤーをグループ単位で管理したい。契約条件を正しく反映してポイントを運用したいから
...
## 16. ユーザーとして、DVCポイントの利用可能数を月ごとに把握し、利用登録したい。失効を避けつつ最適にポイントを使いたいから
...
## 17. ユーザーとして、期間限定で付与されるDVCポイントを管理したい。ワンタイムユース等で付与されたポイントを正しく反映したいから
...
## 18. ユーザーとして、年表画面でDVCポイント利用履歴を確認し、そのまま編集したい。年表とポイント管理を往復しやすくしたいから
