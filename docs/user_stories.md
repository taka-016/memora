...
Scenario: 年表上でのメンバー別イベント表示
  Given ユーザーの所属グループのメンバー「太郎」の2024年セルの固定表示の次の行にイベント「誕生日」が存在している
  When ユーザーが所属グループの年表を表示する
  Then 年表のメンバー別イベント行の2024年セルで、年齢・学年・厄年などの固定表示の次の行にイベント「誕生日」が表示される
...
Scenario: メンバー別イベントの追加
  Given メンバー「太郎」の2024年セルの固定表示の次の行にメンバー別イベントが存在しない
  When ユーザーが年表のメンバー「太郎」行の2024年セルを選択する
  And フリー入力メモに「結婚式」を入力して保存する
  Then メンバー「太郎」の2024年セルの固定表示の次の行にメンバー別イベント「結婚式」が登録される

Scenario: メンバー別イベントの編集
  Given メンバー「太郎」の2024年セルの固定表示の次の行にメンバー別イベント「結婚式」が存在している
  When ユーザーが年表のメンバー「太郎」行の2024年セルを選択する
  And フリー入力メモを「太郎の結婚式」に変更して保存する
  Then メンバー「太郎」の2024年セルの固定表示の次の行のメンバー別イベントが「太郎の結婚式」に更新される

Scenario: メンバー別イベントの削除
  Given メンバー「太郎」の2024年セルの固定表示の次の行にメンバー別イベント「結婚式」が存在している
  When ユーザーが年表のメンバー「太郎」行の2024年セルを選択する
  And フリー入力メモを空にして保存する
  Then メンバー「太郎」の2024年セルの固定表示の次の行のメンバー別イベントが削除される
```
