...
- [9. ユーザーとして、旅行の旅程を管理したい。旅先での詳細な旅程をグループで共有したいから](#9-ユーザーとして旅行の旅程を管理したい旅先での詳細な旅程をグループで共有したいから)
...
## 9. ユーザーとして、旅行の旅程を管理したい。旅先での詳細な旅程をグループで共有したいから
...
Scenario: 旅程項目を1件ずつリストに追加して登録
  ...
  When ユーザーが旅程項目「朝食」を開始時刻「2024-01-02 08:00」、終了時刻「2024-01-02 09:00」でリストに追加する
  And ユーザーが旅程項目「首里城観光」を開始時刻「2024-01-02 10:00」、終了時刻「2024-01-02 12:00」でリストに追加する
  And ユーザーが保存する
  Then 旅行「沖縄旅行」の旅程項目として「朝食」と「首里城観光」がitinerary_itemsに永続化される
...
Scenario: 旅程項目の編集
  ...
  And 変更内容がitinerary_itemsに永続化される
