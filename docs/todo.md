...
### 1. 各ビルドのユーザーストーリーを更新する

- オンライン版ではユーザー登録とログインを行って利用する
- オンライン版では現在提供している地図、訪問場所、共有、招待、アカウント管理を引き続き利用できる
- オフライン版ではユーザー登録、ログイン、利用料金の支払いをせずに利用を開始できる
- オフライン版ではインターネット接続がなくても、Androidウィジェットを含む対象機能を利用できる
- オフライン版ではアカウント管理、地図、地図を前提とする訪問場所管理、場所検索、現在地、共有、招待を利用できない
- ユーザーは利用中のアプリをオンライン版またはオフライン版へ切り替えることができない
- オフライン版ではデータを手動でバックアップ・復元できる
- オフライン版はバックアップがない状態でアプリを削除、データを消去、または端末を故障・紛失した場合にデータを復元できない
...
- オンライン版とオフライン版のデータを共有・同期・移行する機能は実装しない
