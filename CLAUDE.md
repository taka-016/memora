...
- すべての作業は`CLAUDE.md`の**TDDワークフロー定義**に従って進めること（例外は認めない）
...
2. ユーザーからの指示に該当する作業が`doc/todo_list.md`に存在しない場合は、**必ず作業を中断**してユーザーに確認する
