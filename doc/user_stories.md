...
- [21. ユーザーとして、地図表示からも旅行情報を編集したい。場所から旅行を探すこともあるから](#21-ユーザーとして地図表示からも旅行情報を編集したい場所から旅行を探すこともあるから)
...
## 16. ユーザーとして、旅行管理画面に行かなくても年表上で登録された旅行を確認したい。時系列で旅行を確認したいから
...
## 18. ユーザーとして、旅行先を地図で確認したい。場所を視覚的に把握したいから
...
## 21. ユーザーとして、地図表示からも旅行情報を編集したい。場所から旅行を探すこともあるから
...
Scenario: ハンバーガーメニューでの機能アクセス
  ...
  Then メニューが表示される
  And 「グループ年表」「地図表示」「グループ管理」「メンバー管理」「アカウント設定」の項目が表示される
