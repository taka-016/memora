...
### グループへの自動所属
**ストーリー**: ユーザーとして、作成したグループには必ず自分を所属させたい。所属しないグループを管理することはないから。
...
### 所属グループの表示
**ストーリー**: ユーザーとして、自分の管理外で自分が入っているグループの年表も見たい。別の人がグループを作ることもあるから。
...
### イベントの作成
**ストーリー**: ユーザーとして、年表上でグループのイベントを作成したい。時系列で整理して記録したいから。
...
### イベントの管理
**ストーリー**: ユーザーとして、イベントを管理したい。間違いを修正したり、不要になったイベントを削除したいから。
...
Scenario: 自分が作成したイベントの削除
  ...
  Adn 確認ダイアログ「本当に削除しますか？」で「はい」を選択する
  Then イベント「運動会」が削除される
  And 年表からイベントが削除される
```

### 年表上でのイベント表示
**ストーリー**: ユーザーとして、イベント設定画面に行かなくても年表上で登録されたイベントを確認したい。時系列でイベントを確認したいから。
...
### 旅行の作成
**ストーリー**: ユーザーとして、年表上でグループの旅行を作成したい。時系列で整理して記録したいから。
...
### 旅行の管理
**ストーリー**: ユーザーとして、旅行を管理したい。間違いを修正したり、不要になった旅行を削除したいから。
...
### 年表上での旅行表示
**ストーリー**: ユーザーとして、旅行設定画面に行かなくても年表上で登録された旅行を確認したい。時系列で旅行を確認したいから。
