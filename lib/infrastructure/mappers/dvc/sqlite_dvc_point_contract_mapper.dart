...
class SqliteDvcPointContractMapper {
  static DvcPointContractDto fromRow(Map<String, Object?> row) =>
      DvcPointContractDto(
        id: row['id'] as String,
        groupId: row['group_id'] as String,
        contractName: row['contract_name'] as String,
        contractStartYearMonth: SqliteValues.date(
          row['contract_start_year_month'],
        )!,
        contractEndYearMonth: SqliteValues.date(
          row['contract_end_year_month'],
        )!,
  ...
  static Map<String, Object?> toRow(DvcPointContract value) => {
    ...
    'contract_start_year_month':
        value.contractStartYearMonth.microsecondsSinceEpoch,
    'contract_end_year_month':
        value.contractEndYearMonth.microsecondsSinceEpoch,
