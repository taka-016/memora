...
class AuthNotifier extends Notifier<AuthState> {
  ...
  WatchAuthStateChangesUseCase get watchAuthStateChangesUseCase =>
      ref.read(watchAuthStateChangesUseCaseProvider);
  ...
  SignOutUseCase get signOutUseCase => ref.read(signOutUseCaseProvider);
  ...
  get createUserWithEmailAndPasswordUseCase =>
  ...
  AuthState build() {
    ...
    _authStateSubscription = watchAuthStateChangesUseCase.execute().listen((
      user,
    ) {
  ...
  Future<void> login({required String email, required String password}) async {
    try {
      ...
      await signInWithEmailAndPasswordUseCase.execute(
        email: email,
        password: password,
      );
  ...
  Future<bool> signup({required String email, required String password}) async {
    ...
    try {
      state = const AuthState.loading();
      await createUserWithEmailAndPasswordUseCase.execute(
        email: email,
        password: password,
      );
      isSuccess = true;
