...
import 'package:memora/application/usecases/group/get_groups_usecase.dart';
...
void main() {
  ...
  group('GetGroupsUsecase', () {
    test('グループが複数件取得できること', () async {
      // Arrange
      final groups = [
        Group(id: '1', ownerId: 'admin1', name: 'グループ1', memo: 'メモ1'),
        Group(id: '2', ownerId: 'admin2', name: 'グループ2', memo: 'メモ2'),
      ];
