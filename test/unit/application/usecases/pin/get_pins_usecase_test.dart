...
import 'package:memora/application/usecases/pin/get_pins_usecase.dart';
  ...
  group('GetPinsUseCase', () {
    test('getPinsが呼ばれたとき、Pinのリストを返す', () async {
      ...
      final pinDtos = [
        ...
        PinDto(pinId: '2', latitude: 34.123456, longitude: 135.123456),
      ];
      ...
      expect(result[0].pinId, pinDtos[0].pinId);
      expect(result[1].pinId, pinDtos[1].pinId);
